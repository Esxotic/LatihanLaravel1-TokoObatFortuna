...
@section('container')
    ...
    <div class="col-xl-12 col-lg-7">
        <div class="card shadow mb-4">
            <form method="POST" action="{{ route('daftarObat.update', $obat) }}" class="row g-3">
                @method('put')
                @csrf
                <div class="col-md-6">
                    ...
                    is-invalid
                @enderror"
                        id="nama" name="nama_obat" value="{{ old('nama_obat', $obat->nama_obat) }}" />
                    @error('nama_obat')
                ...
                <div class="col-md-4">
                    ...
                    is-invalid
                @enderror"
                        id="harga" placeholder="Cth. 17000" name="harga" value="{{ old('harga', $obat->harga) }}" />
                    @error('harga')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="col-md-4">
                    ...
                    <select id="jenis" class="form-select" name="jenis_id">
                        @foreach ($jenis as $j)
                            @if (old('jenis_id', $obat->jenis_id) == $j->id)
                ...
                <div class="col-md-4">
                    ...
                    <select id="umur" class="form-select" name="umur_id">
                        @foreach ($umurs as $umur)
                            @if (old('umur_id', $obat->umur_id) == $umur->id)
